...
class ClaudeCodeClient:
    ...
    _HERMES_GATEWAY_SYSTEM_PROMPT = (
        ...
        "  <function_calls><invoke name=\"mcp__hermes-tools__bash\">"
        "<parameter name=\"command\">ls -la</parameter></invoke></function_calls>\n"
        "  <function_calls><invoke name=\"mcp__hermes-tools__read\">"
        "<parameter name=\"path\">/path/to/file</parameter></invoke></function_calls>\n"
        "  <function_calls><invoke name=\"mcp__hermes-tools__write\">"
        "<parameter name=\"path\">/path/to/file</parameter>"
        "<parameter name=\"content\">file contents</parameter></invoke></function_calls>\n\n"
        "ALL required parameters MUST be included — never emit empty arguments:\n"
        "  - mcp__hermes-tools__bash REQUIRES \"command\" (the shell command string)\n"
        "  - mcp__hermes-tools__read REQUIRES \"path\" (absolute file path)\n"
        "  - mcp__hermes-tools__write REQUIRES \"path\" and \"content\"\n"
        "  - mcp__hermes-tools__edit REQUIRES \"path\" and \"input\"\n"
        "  - mcp__hermes-tools__find REQUIRES \"paths\" (array of glob patterns)\n\n"
