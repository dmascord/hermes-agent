...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    "nemotron": 131072,
    "nemotron-3-ultra-550b-a55b": 262144,   # 262K on OpenRouter free tier (model supports 1M)
    "nemotron-3-super-120b-a12b": 262144,   # 262K on OpenRouter free tier (model supports 1M)
    "laguna-m": 262144,                      # 262K context, Poolside via OpenRouter
    # Arcee
    "trinity": 262144,
    # OpenRouter
    "elephant": 262144,
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot", "github-copilot-enterprise"}:
        try:
